...
:: block some random telemetry, thanks qtpc
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\wsqmcons.exe" /v Debugger /t REG_SZ /d "C:\Windows\System32\systray.exe" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\compattelrunner.exe" /v Debugger /t REG_SZ /d "C:\Windows\System32\systray.exe" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\elevation_service.exe" /v Debugger /t REG_SZ /d "C:\Windows\System32\systray.exe" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\devicecensus.exe" /v Debugger /t REG_SZ /d "C:\Windows\System32\systray.exe" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\gamebarpresencewriter.exe" /v Debugger /t REG_SZ /d "C:\Windows\System32\systray.exe" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\MusNotification.exe" /v Debugger /t REG_SZ /d "C:\Windows\System32\systray.exe" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\MusNotificationUx.exe" /v Debugger /t REG_SZ /d "C:\Windows\System32\systray.exe" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\MusNotifyIcon.exe" /v Debugger /t REG_SZ /d "C:\Windows\System32\systray.exe" /f
